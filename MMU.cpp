...
uint8_t MemoryMangerUnit::load_byte(uint32_t addr, bool use_cache = true) {
    if (use_cache == false) {
...
uint16_t MemoryMangerUnit::load_2byte(uint32_t addr, bool use_cache = true) {
...
uint32_t MemoryMangerUnit::load_4byte(uint32_t addr, bool use_cache = true) {
...
uint64_t MemoryMangerUnit::load_8byte(uint32_t addr, bool use_cache = true) {
